...
#teste 9
    ...
    def save(self):
        ...
        ofertada.curso = DisciplinaOfertada.objects.filter(curso=self.curso)
        ofertada.ano = DisciplinaOfertada.objects.filter(ano=self.ano)
        ofertada.semestre = DisciplinaOfertada.objects.filter(semestre=self.semestre)
        ofertada.turma = DisciplinaOfertada.objects.filter(turma=self.turma)
        ofertada.professor = DisciplinaOfertada.objects.filter(professor=self.professor)
        ofertada.disciplina = DisciplinaOfertada.objects.filter(disciplina=self.disciplina)
